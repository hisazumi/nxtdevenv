/* Configured with [-s tmpfile1 -c -obj ] */
...
static __STK_UNIT __stack_TSK0[__TCOUNT_STK_UNIT(1024)];

const TINIB _kernel_tinib_table[TNUM_TSKID] = {
	{0x00u | 0x02u, (VP_INT)(TSK0), (FP)(tsk0), INT_PRIORITY(1), __TROUND_STK_UNIT(1024), __stack_TSK0, TA_NULL, (FP)(NULL)}
};
...
const INHINIB _kernel_inhinib_table[TNUM_INHNO] = {
	{10,0,(FP)CFG_INT_ENTRY(jsp_systick_low_priority)}
};
