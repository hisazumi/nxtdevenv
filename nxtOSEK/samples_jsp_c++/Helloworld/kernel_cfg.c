...
static __STK_UNIT __stack_TSK[__TCOUNT_STK_UNIT(1024)];

const TINIB _kernel_tinib_table[TNUM_TSKID] = {
	{TA_HLNG | TA_ACT, (VP_INT)(TSK), (FP)(tsk), INT_PRIORITY(1), __TROUND_STK_UNIT(1024), __stack_TSK, TA_NULL, (FP)(NULL)}
};
